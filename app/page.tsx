    ...
    <main>
      ...
      <div id="main-content" className="shell">
        ...
        <section id="shop" className="shop-section">
          ...
          <div className="catalog-tools"><span>{filtered.length} منتج متاح</span><label>ترتيب <select value={sortMode} onChange={(event) => setSortMode(event.target.value)} aria-label="ترتيب المنتجات"><option value="featured">الأبرز أولًا</option><option value="price-low">الأقل سعرًا</option><option value="price-high">الأعلى سعرًا</option><option value="name">حسب الاسم</option></select></label></div>
